...
Public Class frmInvPrint
    ...
    Public Shared Function LoadInvoiceDetails(ByVal invoiceNo As String, ByVal fromDate As String, ByVal toDate As String, ByVal fromAmount As String, ByVal toAmount As String, ByVal debtor As String, _
     ByVal customer As String, ByVal orderNo As String, ByVal vehRegNo As String, ByVal flgBatchInv As String, ByVal invStatus As String) As Collection
        ...
        Try
            ...
            dtConfig = objInvDetServ.FetchInvoices(invoiceNo, fromDate, toDate, fromAmount, toAmount, customer, debtor, vehRegNo, orderNo, invStatus, flgBatchInv, searchBasedOnAmount, searchBasedInvDate)
        Catch ex As Exception
