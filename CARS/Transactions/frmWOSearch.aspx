    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnSpareList').on('click', function () {
                var txt_Spare = '#<%=txtSpare.ClientID%>';
                var search_String = $(txt_Spare).val();
                //$('#modSpare').removeClass('hidden');
                //$('.overlayHide').addClass('ohActive');
                $('#systemMSG').show();
                ...
                $dialog.dialog('open');
                $('#msSearch').val(search_String).focus().select();
            });
            ...
            $('#<%=txtSpare.ClientID%>').autocomplete({
                ...
                source: function (request, response) {
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.d.length === 0) { // If no hits in local search, prompt create new, sends user to new vehicle if enter is pressed.
                                response([{ label: 'Ingen treff i lokalt lager. Trykk enter for å sjelle non-stock registeret.', value: '0', val: 'new' }]);
            ...
            $('#btnCustList').on('click', function (e) {
                ...
                //e.preventDefault();
                //e.stopPropagation();
                //$('#modCustomer').removeClass('hidden');
                //$('.overlayHide').addClass('ohActive');
                //$('#mcSearch').val(search_String).focus().select();
                //fetchCustomer(search_String);
                //overlay('on', 'modCustomer');
        ...
        <div class="six wide column">
            ...
            <div class="field">
                <div class="ui action input mini">
                    ...
                    <input id="btnVehList" type="button" value="S&oslash;k" class="ui btn" width="90px" value="Work Order Search" />
