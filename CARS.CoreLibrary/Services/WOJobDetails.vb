...
loadBack:       If (warning = "Exists") Then
        ...
        Public Function CheckCreditLimit() As String
            ...
            End Try
        End Function
        Public Function LoadReport(ByVal reportType As String, ByVal reportRequest As String, ByVal orderType As String) As List(Of WOJobDetailBO)
            Dim details As New List(Of WOJobDetailBO)()
            Try
                ...
                Select Case reportType
                    ...
                    Case "DELIVERYNOTE"
                        Dim cfSubsidiary As New CARS.Department.ConfigDepartmentDO
                        ...
                        Dim _readytoInvoice As Boolean = False
                        With _reportsettings
                            .ReportID = "DELIVERYNOTE"
                            .Department = department
                            .Subsidiary = subsidiary
                            .OrderType = orderType
                            _settings = .LoadDisplaySettings
                        End With
                        Dim drarr As DataRow() = _settings.Tables(0).Select("REF = 'chkReadytoInvoice'")
                        If drarr.Length > 0 Then
                            If Not drarr(0)("DISPLAY") Is DBNull.Value Then
                                _readytoInvoice = drarr(0)("DISPLAY")
                            End If
